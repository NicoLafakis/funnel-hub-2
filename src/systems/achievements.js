...
// the joke voice and title puns are otherwise untouched. Five new entries
// (metroCleared/centurion/hoarder per the redesign plan, duelist/secondWind
// per V2 game-design.md §4/§6) are added, for 16 keys total.
//
...
export const ACH = {
  ...
  // --- V2 additions (game-design.md) ---
  // §4 rivals: fires when the player eats a Duelist-archetype rival.
  duelist: ['🤺 Duel Won', 'You ate the Duelist. It specifically asked for this.'],
  // §6 mercy rules: fires when the player accepts the second-wind offer.
  secondWind: ['🌬️ Second Wind', 'You took the extra 15 seconds. Make them count.'],
};
