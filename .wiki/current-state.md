...
8. **City realism debt — REMEDIATED 2026-07-30:** the [`0011-level1-city-realism-review`](0011-level1-city-realism-review/00-overview.md) package (2026-07-29, captured live post-`c0e8568`) ranked eight illusion-breakers ahead of item 6's dark-street finding. **Implemented and live:** facade re-exposure (dark-glass mean 40.2 → 92.2), Chicago identity colours on textured groups, `DOOR_GLASS`/`TRIM` albedo lift, a pale drained cloudless sky (`#99cae6`/`#d6e4f0`, Level-1-gated), corrected road-paint gauge (centre 1.5 / edge 1.6 / dash 24:72 / pitch 66), park furniture on real features + promenade paths, water that moves and glints with a graded shoreline (plus a 2× texture lift), varied roof crowns, shopfront awnings + glazing, round trees, 107-vehicle traffic, prop detail atlases with a muted palette. Re-scored ~6.5–7/10 street (was 4/10), ~8.5/10 high camera (was 7/10) — evidence `shots/review-r2/`. The ground-plane defect (item 5) closed as unreachable without a fix; the cloud task was dropped (reference is cloudless). Only task 19 (collectible prop geometry uplift) remains, blocked on Blender.
