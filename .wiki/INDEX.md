...
- [`0011-level1-city-realism-review/00-overview.md`](0011-level1-city-realism-review/00-overview.md) — live post-`c0e8568` city-realism review of Level 1 plus a full implementation-ready remediation package: `00-findings.md` (ranked illusion-breakers — dark/black-cutout towers, clashing art directions, oversized road markings, flat sky, a ground-plane defect, board-game parks, flat water, flat roofs — with errata correcting the stated cause of three items after reading the code), `requirements.md`, `design.md`, `tasks.md`, `test-strategy.md`, and [`ADR 0005 — Level 1 props rise to the photographic facades`](0011-level1-city-realism-review/adr/0005-level1-props-rise-to-photographic-facades.md), evidence in `shots/l1-realism-review/`. Status: findings recorded, remediation package proposed and design-complete; nothing implemented or approved, all look-and-feel items (†) still need Nico's per-element sign-off.
