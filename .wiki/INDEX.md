...
- [`0011-level1-city-realism-review/00-overview.md`](0011-level1-city-realism-review/00-overview.md) — live post-`c0e8568` city-realism review of Level 1 (The Loop), remediated 2026-07-30: Phase-0 measurements (brightness at 46% of reference, sky-gradient inversion, baked-paint shopfronts, unreachable ground-clip, real 333-call/114-group budget), then facade re-exposure, identity colours, DOOR_GLASS/TRIM albedo lift, a pale drained sky (cloud task dropped — the reference is cloudless), corrected road-paint gauge, park furniture on real features + promenade paths, moving/glinting water with a shoreline, varied roof crowns, awnings + glazed shopfronts, round trees, 107-vehicle traffic, and prop detail atlases with a muted palette. `00-findings.md` (ranked illusion-breakers + measurement addenda), `requirements.md`, `design.md`, `tasks.md`, `test-strategy.md`, [`ADR 0005`](0011-level1-city-realism-review/adr/0005-level1-props-rise-to-photographic-facades.md); evidence in `shots/l1-realism-review/` (baseline) and `shots/review-r2/` (re-scored ~6.5–7/10 street, ~8.5/10 high camera). Only task 19 (collectible prop *geometry* uplift) remains, blocked on Blender.
