...
A HubSpot-flavored [hole.io](https://hole-io.com/) game built with HTML5 Canvas.

A rogue data hole just opened inside the HubSpot platform. Swallow every record, deal, ticket and workflow across **10 Hubs** — grow big enough to eat the whole CRM.
...
- **Mouse / touch drag** — move the hole
...
- **🎨 AI-generated art** — start-screen hero backdrop, logo emblem (also the favicon) and win-screen trophy art, generated with Leonardo AI (`assets/`). Regenerate any time:
  ...
  ```
- **🌀 Animated vortex hole** — spiral arms, pulsing depth ring, fake-glow rim. Objects spaghettify as they fall in.
...
- **🕳️ Edible rivals** — out-grow a rival hole, then swallow it for a massive bonus. There can be only one.
- **🏆 11 achievements** — from *First Contact... Consumed* to *Platform Apocalypse*.
- **💬 Comedy everywhere** — every object type has its own quips, plus fake CRM notifications, sassy level intros/outros, and growing titles from *Data Gremlin* to *CRM Black Hole*.
...
| 6 | Operations Hub | **Rival hole** appears — don't let it steal your workflows |
| 7 | Commerce Hub | **Rival hole** — protect invoices, carts and payments |
| 8 | Reporting & Analytics | **Rival hole** — swallow dashboards and charts |
| 9 | App Marketplace & Automation | **Two rival holes** compete for integrations |
